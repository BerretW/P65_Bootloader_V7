...
ca65 --cpu 65c02 vera.asm -o ..\output\vera.o -l ..\lst\vera.lst
ca65 --cpu 65c02 font/sysfont.asm -o ..\output\sysfont.o -l ..\lst\sysfont.lst
...
ld65 -C ..\config\APP_RAM_DISK.cfg -m ram.map main.o spi.o acia.o vera.o sysfont.o jumptable.o pckybd.o utils.o sn76489.o zeropage.o ewoz.o vectors.o interrupts.o ..\library\p65.lib -o ..\output\RAM.bin

ld65 -C ..\config\appartus.cfg -m rom.map main.o spi.o acia.o vera.o sysfont.o jumptable.o pckybd.o utils.o sn76489.o zeropage.o ewoz.o vectors.o interrupts.o ..\library\p65.lib -o ..\output\ROM.bin
